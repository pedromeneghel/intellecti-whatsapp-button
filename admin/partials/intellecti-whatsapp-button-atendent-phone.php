...
?>
<p>
    <label for="iwb_atendent_phone">
        <? _e('Informe o número de telefone do atendente com WhatsApp. Esse número receberá as solicitações de atendimento vindas através do plugin.', 'intellecti-whatsapp-button-locale') ?></label>
    <br /><br />

...
<p>
    <label for="iwb_end_hour_tuesday">Horário de Término</label>
    <input type="time" name="iwb_end_hour_tuesday" id="iwb_end_hour_tuesday" value="<?= get_post_meta($post->ID, '_iwb_end_hour_tuesday', true); ?>">
</p>

<h3>Quarta-feira</h3>
<p>
    <label for="iwb_start_hour_wednesday">Horário de Início</label>
...
<p>
    <label for="iwb_end_hour_wednesday">Horário de Término</label>
...
<h3>Quinta-feira</h3>
<p>
    <label for="iwb_start_hour_thursday">Horário de Início</label>
...
<p>
    <label for="iwb_end_hour_thursday">Horário de Término</label>
...
<h3>Sexta-feira</h3>
<p>
    <label for="iwb_start_hour_friday">Horário de Início</label>
...
<p>
    <label for="iwb_end_hour_saturday">Horário de Término</label>
...
<h3>Domingo</h3>
<p>
    <label for="iwb_start_hour_sunday">Horário de Início</label>
...
<p>
    <label for="iwb_end_hour_sunday">Horário de Término</label>
